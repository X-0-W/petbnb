...
i = 1
12.times do
  pet = Pet.new(name: DOG_NAMES.sample, species: 'dog', toilet_trained: TOILET_TRAINED.sample, description: "best pet ever, man and womans best friend, sometimes pees on the floor but still very lovable", price_per_day: rand(25..100), user_id: rand(1..4))
...
rabbit = Pet.new(name: DOG_NAMES.sample, species: 'dog', toilet_trained: TOILET_TRAINED.sample, description: "hops a lot, big ball of fluff - great for hugs", price_per_day: rand(25..100), user_id: rand(1..4))
...
wallaby = Pet.new(name: DOG_NAMES.sample, species: 'wallaby', toilet_trained: TOILET_TRAINED.sample, description: "bit wild but much nicer than a kangaroo", price_per_day: rand(25..100), user_id: rand(1..4))
...
dog = Pet.new(name: DOG_NAMES.sample, species: 'dog', toilet_trained: TOILET_TRAINED.sample, description: "best pet ever, man and woman's best friend. Sometimes pees on the floor but still very lovable", price_per_day: rand(25..100), user_id: rand(1..4))
